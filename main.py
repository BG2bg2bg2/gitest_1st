...
#store
#stats/data
    #display you are level (Changeable) and (changable) rank
...
#while true
    ...
    #ask user what eye color they want
...
#while true
    ...
    #else if item cost is under money amount
        #subtract money from item amount
